...
//But a "real world" solution should
...
export class Textures{
    ...
    static async load(gl, src, useBilinearFiltering, generateMipMaps){
        ...
        try{
            ...
            const texId = await Textures.loadTexture2DFromImage(gl, image, useBilinearFiltering, generateMipMaps, false);
